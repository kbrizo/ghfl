...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$ghfl_description = get_bloginfo( 'description', 'display' );
			if ( $ghfl_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $ghfl_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
